...
public class ArmorListener implements Listener{
    ...
    public final void inventoryClick(final InventoryClickEvent ev){
        ...
        if(ev.getClick().equals(ClickType.SHIFT_LEFT) || ev.getClick().equals(ClickType.SHIFT_RIGHT)){
            shift = true;
        }
        ...
        if(shift){
            ...
            if(newArmorType != null){
                ...
                if(ev.getRawSlot() == newArmorType.getSlot()){
                    equipping = false;
                }
                if(newArmorType.equals(ArmorType.HELMET) && (equipping ? isAirOrNull(ev.getWhoClicked().getInventory().getHelmet()) : !isAirOrNull(ev.getWhoClicked().getInventory().getHelmet())) || newArmorType.equals(ArmorType.CHESTPLATE) && (equipping ? isAirOrNull(ev.getWhoClicked().getInventory().getChestplate()) : !isAirOrNull(ev.getWhoClicked().getInventory().getChestplate())) || newArmorType.equals(ArmorType.LEGGINGS) && (equipping ? isAirOrNull(ev.getWhoClicked().getInventory().getLeggings()) : !isAirOrNull(ev.getWhoClicked().getInventory().getLeggings())) || newArmorType.equals(ArmorType.BOOTS) && (equipping ? isAirOrNull(ev.getWhoClicked().getInventory().getBoots()) : !isAirOrNull(ev.getWhoClicked().getInventory().getBoots()))){
